 ...
 *
 * @param options
 * @param options.root - project root directory (typically __dirname from vite.config.js)
 * @param options.entrypointsDir - relative to root
 * @param options.stylesRoot - relative to root
 * @param options.sources - subdirectory names to scan within stylesRoot
 */
