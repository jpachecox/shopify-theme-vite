...
| File              | Holds                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `_functions.scss` | **Calculations & Accessors:** `fn.rem()`, `fn.strip-unit()`, `fn.map-get-strict()` (validates map/key types and fails loud with `@error` on missing keys, listing available keys), `fn.breakpoint()`, `fn.spacing()`, `fn.radius()`, `fn.elevation()`, `fn.gray()` (compile-time fallback only), `fn.shadow-border()`, `fn.token-get()`, and `fn.font-stack()`.                                                                                                                                                                                                                                                                                                                                   |
...
- Public mixins validate token keys, enum values, dimensions, and CSS argument
  types before emitting declarations. Invalid arguments stop Sass compilation.
- Token accessors (`fn.spacing()`, `fn.radius()`, `fn.elevation()`,
  `fn.breakpoint()`) fail the Sass build for an unknown token, listing the
  available keys; `fn.shadow-border()` rejects unsupported states. All
  accessors share `fn.map-get-strict()` as their validation base.
